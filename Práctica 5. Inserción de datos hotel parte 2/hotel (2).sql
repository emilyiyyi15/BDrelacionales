...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 19-02-2026 a las 16:18:16
...
(1, 0, 2, '2026-02-05', '2 de 10, se portó muy prepoten'),
(4, 0, 7, '2026-02-18', 'Trato amable'),
(6, 0, 3, '2026-02-03', 'trato amable y toda la cosa'),
(8, 0, 1, '2026-01-30', 'Malo porque tuve problemas y n'),
(10, 0, 4, '2026-02-14', 'Muy mal trato definitivamente ');
...
(1, 6, '2025-04-11', 2999, 'Efectivo', '0428', 'Cancelado'),
(2, 10, '2026-02-14', 2999, 'Tarjeta', '0467', 'Realizado'),
(3, 3, '2026-02-03', 1999, 'Efectivo', '3487', 'Realizado'),
(5, 4, '2026-02-08', 2499, 'Efectivo', '066767', 'Pendiente'),
(6, 3, '2026-01-30', 2999, 'Efectivo', '04678', 'Realizado');
...
CREATE TABLE `reserva_servicio` (
  `reserva_servicio` int(11) NOT NULL,
  `id_reserva` int(11) NOT NULL,
  `id_servicio` int(11) NOT NULL,
  `cantidd` int(11) NOT NULL,
...
(3, 'Lavandería', 700),
(4, 'Masaje', 799),
(5, 'Servicio a la habitación', 1200),
(6, 'Gimnasio', 750);
...
ALTER TABLE `reserva_servicio`
  ADD PRIMARY KEY (`reserva_servicio`),
  ADD KEY `id_reserva` (`id_reserva`),
...
--
ALTER TABLE `reserva_servicio`
  MODIFY `reserva_servicio` int(11) NOT NULL AUTO_INCREMENT;
